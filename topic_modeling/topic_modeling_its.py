...
plt.text(interruption_index - 0.2, y[interruption_index] - 30, "July 11, 2023 - EMA\nStatement on Suicide Risk", color='black', ha='right', va='bottom')

plt.title("Interrupted Time Series Analysis — T6 (Suicide Risk)")
